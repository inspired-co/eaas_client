...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--path_inputs", type=str, required=True, help="Input texts to be evaluated"
    )
    parser.add_argument(
        "--metrics",
        type=str,
    ...
    parser.add_argument(
        "--task", type=str, default="sum", help="The task of interest, can be sum/mt."
    )
    parser.add_argument("--lang", type=str, default="en", help="Language of hypotheses")
